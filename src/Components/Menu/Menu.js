...
const getMenuItems = () => {
  return (
    <MenuList>
      {menuItem(
        'About Me',
        <AccountIcon style={{color: pink[600]}} />,
        'about',
      )}
      {menuItem(
        'Education',
        <SchoolIcon style={{color: pink[600]}} />,
        'education',
      )}
      {menuItem(
        'Experience',
        <TimelineIcon style={{color: pink[600]}} />,
        'experience',
      )}
      {menuItem('Skills', <CodeIcon style={{color: pink[600]}} />, 'skills')}
      {menuItem(
        'Impact',
        <TrendingUpIcon style={{color: pink[600]}} />,
        'impact',
      )}
      {menuItem(
        'Books',
        <LocalLibraryIcon style={{color: pink[600]}} />,
        'books',
      )}
      {menuItem(
        'Contact',
        <ContactsIcon style={{color: pink[600]}} />,
        'contact',
      )}
      {menuItem(
        'Articles',
